 ...
 * @version $Id: SubResourceHandler.java 19933 2010-12-11 15:27:37Z tmatyashovsky $
 */
public interface SubResourceHandler extends ResourceHandler {

	Resource setSubResource(Resource parent, ServiceRequest request)
			throws WSException;

	void deleteSubResource(Resource parent, ResourceDescriptor childDescriptor,
