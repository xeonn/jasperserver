...
public class SampleCustomDataSourceWithMetadata implements JRDataSource, CustomDomainMetaDataProvider
{
	 ...
	 *
	 */
	public SampleCustomDataSourceWithMetadata()
	{
	}
    ...
    public CustomDomainMetaData getCustomDomainMetaData(CustomReportDataSource customReportDataSource) {
        ...
        fieldNameList.add("the_city");
        fieldNameList.add("id");
        fieldNameList.add("name");
        fieldNameList.add("street");
