...
public class FunctionFilterELDeserializationFromJSONTest extends QueryTest {
    ...
    public void ensureDateEquals_timestamp() throws Exception {
        ...
        assertThat(cq.getWhere().getFilterExpressionObject(), is(instanceOf(ClientFunction.class)));
        assertThat(((ClientFunction) cq.getWhere().getFilterExpressionObject()).getFunctionName(), is((ClientExpressions.EQUALS_DATE_FUN)));
        assertThat(((ClientFunction) cq.getWhere().getFilterExpressionObject()).getOperands().get(0), is((instanceOf(ClientVariable.class))));
        assertThat(((ClientFunction) cq.getWhere().getFilterExpressionObject()).getOperands().get(1), is((instanceOf(ClientTimestamp.class))));
    }
    ...
    public void ensureDateEquals_timestamp_filterExpression() throws Exception {
        ...
        assertThat(cq, is(instanceOf(ClientQuery.class)));
        assertThat(cq.getWhere().getFilterExpression(), is("equalsDate(hire_date,ts'2009-12-01 00:00:00')"));
        assertThat(cq.getWhere().getFilterExpressionObject(), is(nullValue()));
    }
    ...
    public void ensureDateAfter_timestamp() throws Exception {
        ...
        assertThat(cq, is(instanceOf(ClientQuery.class)));
        assertThat(cq.getWhere().getFilterExpressionObject(), is(instanceOf(ClientFunction.class)));
        assertThat(((ClientFunction) cq.getWhere().getFilterExpressionObject()).getFunctionName(), is((ClientExpressions.AFTER_DATE_FUN)));
        assertThat(((ClientFunction) cq.getWhere().getFilterExpressionObject()).getOperands().get(0), is((instanceOf(ClientVariable.class))));
        assertThat(((ClientFunction) cq.getWhere().getFilterExpressionObject()).getOperands().get(1), is((instanceOf(ClientTimestamp.class))));
    }
    ...
    public void ensureDateBetween_timestamp() throws Exception {
        ...
        assertThat(cq, is(instanceOf(ClientQuery.class)));
        assertThat(cq.getWhere().getFilterExpressionObject(), is(instanceOf(ClientFunction.class)));
        assertThat(((ClientFunction) cq.getWhere().getFilterExpressionObject()).getFunctionName(), is((ClientExpressions.BETWEEN_DATE_FUN)));
        assertThat(((ClientFunction) cq.getWhere().getFilterExpressionObject()).getOperands().get(0), is((instanceOf(ClientVariable.class))));
        assertThat(((ClientFunction) cq.getWhere().getFilterExpressionObject()).getOperands().get(1), is((instanceOf(ClientTime.class))));
        assertThat(((ClientFunction) cq.getWhere().getFilterExpressionObject()).getOperands().get(2), is((instanceOf(ClientTime.class))));
    }
