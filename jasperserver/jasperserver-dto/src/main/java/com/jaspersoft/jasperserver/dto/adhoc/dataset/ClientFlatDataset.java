 ...
 * @version $Id: ClientFlatDataset.java 64626 2016-09-26 13:25:24Z vzavadsk $
 */
...
public class ClientFlatDataset {
    ...
    public ClientFlatDataset(ClientFlatDataset dataset) {
        ...
        if (dataset.getFields() != null) {
            for (ClientDatasetFieldReference field : dataset.getFields()) {
                fields.add(new ClientDatasetFieldReference(field));
            }
        }
    ...
    public void setFields(List<ClientDatasetFieldReference> fields) {
        this.fields = fields;
    }
