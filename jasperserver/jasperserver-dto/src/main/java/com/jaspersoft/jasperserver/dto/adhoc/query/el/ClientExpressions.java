...
public class ClientExpressions {
    ...
    public static ClientLiteral literal(Long value){
        return ClientBigInteger.valueOf(value);
    }
    ...
    public static ClientLiteral literal(BigDecimal value) {
        return new ClientDecimal(value.doubleValue());
    }
    ...
    public static ClientLiteral literal(String type, Object value) {
        return ClientLiteral.createLiteral(type, value);
    }
