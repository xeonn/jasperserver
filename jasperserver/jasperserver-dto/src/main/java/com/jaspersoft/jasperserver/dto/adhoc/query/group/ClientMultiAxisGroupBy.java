...
public class ClientMultiAxisGroupBy implements ClientGroupBy<ClientLevelAxis> {
    ...
    public ClientMultiAxisGroupBy(ClientMultiAxisGroupBy groupBy) {
        if (groupBy != null) {
            if (groupBy.rows != null) {
                this.setRows(new ClientLevelAxis(groupBy.rows));
            }
            if (groupBy.columns != null) {
                this.setRows(new ClientLevelAxis(groupBy.columns));
            }
        }
    }
