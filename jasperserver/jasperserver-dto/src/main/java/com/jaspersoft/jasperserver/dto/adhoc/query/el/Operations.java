 ...
 * @version $Id: Operations.java 64791 2016-10-12 15:08:37Z ykovalch $
 */
public abstract class Operations<T extends ClientExpression> {
    ...
    public ClientComparison eq(BigDecimal value) {
        return ClientComparison.eq(getMe(), new ClientDecimal().setValue(value.doubleValue()));
    }
    ...
    public ClientComparison eq(Long value){
        return ClientComparison.eq(getMe(), ClientBigInteger.valueOf(value));
    }
    ...
    public ClientComparison notEq(Double value) {
        return ClientComparison.notEq(getMe(), new ClientDecimal(value));
    }

    public ClientComparison notEq(Integer value) {
        return ClientComparison.notEq(getMe(), new ClientInteger().setValue(value));
    }

    public ClientComparison notEq(Long value) {
        return ClientComparison.notEq(getMe(), ClientBigInteger.valueOf(value));
    }

    public ClientComparison notEq(BigInteger value) {
        return ClientComparison.notEq(getMe(), new ClientBigInteger().setValue(value));
    }
    ...
    public ClientComparison gtOrEq(Integer value) {
        return ClientComparison.gtOrEq(getMe(), new ClientInteger().setValue(value));
    }

    public ClientComparison gtOrEq(Long value) {
        return ClientComparison.gtOrEq(getMe(), ClientBigInteger.valueOf(value));
    }

    public ClientComparison gtOrEq(BigInteger value) {
        return ClientComparison.gtOrEq(getMe(), new ClientBigInteger().setValue(value));
    }

    public ClientComparison gtOrEq(Double value) {
        return ClientComparison.gtOrEq(getMe(), new ClientDecimal(value));
    }

    public ClientComparison gtOrEq(BigDecimal value) {
        return ClientComparison.gtOrEq(getMe(), new ClientDecimal(value.doubleValue()));
    }
    ...
    public ClientComparison ltOrEq(Long value) {
        return ClientComparison.ltOrEq(getMe(), ClientBigInteger.valueOf(value));
    }
    ...
    public ClientComparison ltOrEq(Double value) {
        return ClientComparison.ltOrEq(getMe(), new ClientDecimal(value));
    }

    public ClientComparison ltOrEq(BigDecimal value) {
        return ClientComparison.ltOrEq(getMe(), new ClientDecimal(value.doubleValue()));
    }
    ...
    public ClientComparison gt(Double value) {
        return ClientComparison.gt(getMe(), new ClientDecimal(value));
    }
    ...
    public ClientComparison gt(Long value) {
        return ClientComparison.gt(getMe(), ClientBigInteger.valueOf(value));
    }
    ...
    public ClientComparison gt(BigDecimal value) {
        return ClientComparison.gt(getMe(), new ClientDecimal(value.doubleValue()));
    }
    ...
    public ClientComparison lt(Long value) {
        return ClientComparison.lt(getMe(), ClientBigInteger.valueOf(value));
    }
    ...
    public ClientComparison lt(Double value) {
        return ClientComparison.lt(getMe(), new ClientDecimal(value));
    }

    public ClientComparison lt(BigDecimal value) {
        return ClientComparison.lt(getMe(), new ClientDecimal(value.doubleValue()));
    }
