 ...
 * @version $Id $
 */
public abstract class ClientQueryVisitorAdapter extends ClientELVisitorAdapter implements ClientQueryVisitor {

    @Override
    public void visit(ClientWhere clientWhere) {

    }

    @Override
    public void visit(ClientQueryField aggregatedField) {

    }

    @Override
    public void visit(ClientQueryAggregatedField aggregatedField) {

    }

    @Override
    public void visit(ClientSelect clientSelect) {
