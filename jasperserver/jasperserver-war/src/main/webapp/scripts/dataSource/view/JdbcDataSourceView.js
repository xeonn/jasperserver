...
define(function(require) {
    ...
    return BaseDataSourceView.extend({
        ...
        changeUploadDriverButtonState: function() {
            ...
            if (currentDriver.isOtherDriver()) {
                buttonManager[this.model.get("driverClass") === "" ? "disable" : "enable"]($driverUploadButton[0]);
                $driverUploadButton.find(".wrap").text(i18n["resource.dataSource.jdbc.upload.addDriverButton"]);
            } else {
