...
/**
 * @version $Id: item.hyperlink.service.js 45580 2014-05-10 14:31:59Z inesterenko $
 */
...
define([], function() {
    ...
    JRItemHyperlinkHighchartsSettingService.prototype = {
        ...
        configureChartHyperlink: function(hyperlink) {
            ...
            options.chart.events = createEvents(highchartsOptions.chart.events, wrapChartEvents(linkOptions.events, hyperlink.id));
