...
/**
 * @version $Id: jive.interactive.column.js 45653 2014-05-12 19:43:17Z psavushchik $
 */
...
define(["jquery.ui", "jive"], function($, jive) {
    ...
    jive.interactive.column.columnConditionalFormattingForm = {
        ...
        onCreate: function(jo){
            ...
            form.on('change', 'select[name=conditionTypeOperator-jr-uuid-for-ui-element-0]', function(evt) {
                var self = $(this),
                    row = self.closest('tr'),
