 ...
 * @version: $Id: AvailableItemsListWithTrueAll.js 43947 2014-04-02 17:51:07Z sergey.prilukin $
 */
...
define([
    ...
    "backbone",
    "underscore",
    "text!common/component/multiSelect/templates/availableItemsListDropdownWithTrueAllTemplate.htm",
    "common/component/multiSelect/AvailableItemsList"
], function ($, Backbone, _, availableItemsListDropdownTemplate, AvailableItemsList) {
    'use strict';
    ...
    var AvailableItemsListWithTrueAll = AvailableItemsList.extend({
        ...
        changeTrueAll: function() {
            ...
            this.listView.setDisabled(isTrueAll);
        },
