 ...
 * @version: $Id: SingleSelectListModel.js 43947 2014-04-02 17:51:07Z sergey.prilukin $
 */
...
], function (Backbone, _, ListWithNavigationModel) {
    'use strict';

    var SingleSelectListModel = ListWithNavigationModel.extend({

        /* Methods which supposed to be overridden */

        setActive: function(options) {
            ListWithNavigationModel.prototype.setActive.call(this, _.extend(options, {silent: true}));
        ...
        _convertInitialArrayToSelection: function(data, pendingSelection) {
            for (var i = 0; i < data.length; i++) {
                if (pendingSelection[data[i].value]) {
                    ...
                    if (!this.getActive()) {
                        ListWithNavigationModel.prototype.setActive.call(this, {
        ...
        select: function(selection) {
            ...
            if (!selection || typeof selection === "string" || _.isArray(selection)) {
                ListWithNavigationModel.prototype.setActive.call(this, {silent: true});
            } else {
            ...
            if (shouldFetchLabel) {
                ...
                ListWithNavigationModel.prototype.select.call(this, selection);
            }
