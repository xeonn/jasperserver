 ...
 * @version: $Id: ScalableList.js 43947 2014-04-02 17:51:07Z sergey.prilukin $
 */
...
define([
    ...
    "text!common/component/list/templates/viewPortChunksTemplate.htm"
], function ($, Backbone, _, layoutModule, ScalableListModel, defaultChunksTemplate) {
    'use strict';
    ...
    var ScalableList = Backbone.View.extend({
        ...
        initialize: function(options) {
            ...
            //Backbone automatically set model if it's present in options hash
            if (!this.model) {
                this.model = new this.ListModel(options);
            }
        ...
        initListeners: function() {
            this.listenTo(this.model, "change", this.renderData, this);
        },
        ...
        _getChunkModel: function(options) {
            ...
            _.each(items, function(item, i) {
                this.postProcessChunkModelItem(item, i);
            }, this);
