 ...
 * @version: $Id: SingleSelect.js 43947 2014-04-02 17:51:07Z sergey.prilukin $
 */
...
define([
    ...
    "common/component/singleSelect/SingleSelectList",
    "common/component/singleSelect/SearcheableDataProvider",
    "common/component/singleSelect/DropDownManager",
    "text!common/component/singleSelect/templates/singleSelectTemplate.htm",
    "text!common/component/singleSelect/templates/listTemplate.htm",
    "text!common/component/singleSelect/templates/itemsTemplate.htm",
    "text!common/component/singleSelect/templates/dropDownTemplate.htm",
    ...
    singleSelectListTemplate,
    singleSelectItemsTemplate,
    dropDownTemplate,
    i18n) {
    ...
    var SingleSelect = Backbone.View.extend({
        ...
        initialize: function(options) {
            ...
            //Initialize internal list view
            this.listView = new SingleSelectList({
        ...
        selectionChange: function() {
            ...
            if (active) {
                ...
                this.model.set("activeValue", {
                    value: active.value,
                    label: active.label,
                    index: indexMapping ? indexMapping[active.index] : active.index
                });
        ...
        changeFilter: function() {
            var that = this;
            this.searcheableDataProvider.getData({criteria: this.model.get("criteria")}).done(function() {
        ...
        setValueToList: function() {
            ...
            this.listView.setValue(selection);
        },
