 ...
 * @version: $Id: AvailableItemsList.js 45220 2014-04-29 14:50:56Z sergey.prilukin $
 */
...
define([
    ...
    "backbone",
    "underscore",
    "common/component/singleSelect/KeyboardManager",
    "common/component/list/ListWithNavigation",
    "common/component/list/ListWithNavigationModel",
    "common/component/singleSelect/SearcheableDataProvider",
    "common/component/singleSelect/DropDownManager",
    "text!common/component/multiSelect/templates/availableItemsListTemplate.htm",
    "text!common/component/multiSelect/templates/availableItemsListDropdownTemplate.htm",
    "text!common/component/multiSelect/templates/availableItemsTemplate.htm",
    "text!common/component/multiSelect/templates/listTemplate.htm",
    "bundle!ScalableInputControlsBundle"
], function ($, Backbone, _, KeyboardManager, ListWithNavigation, ListWithNavigationModel,
             SearcheableDataProvider, DropDownManager, availableItemsListTemplate, availableItemsListDropdownTemplate,
             itemsTemplate, listTemplate, i18n) {
    'use strict';
    ...
    var AvailableItemsList = Backbone.View.extend({
        ...
        initialize: function(options) {
            ...
            this.listViewModel = new ListWithNavigationModel({
            ...
            this.listView = new ListWithNavigation({
        ...
        changeValue: function() {
            this.trigger("selection:change", this.model.get("value"));
        },
