 ...
 * @version: $Id: ListWithNavigation.js 43947 2014-04-02 17:51:07Z sergey.prilukin $
 */

define([
    "backbone",
    "underscore",
    "common/component/list/ListWithSelection",
    "common/component/list/ListWithNavigationModel"
], function (Backbone, _, ListWithSelection, ListWithNavigationModel) {
    'use strict';

    var ListWithNavigation = ListWithSelection.extend({

        ListModel: ListWithNavigationModel,
