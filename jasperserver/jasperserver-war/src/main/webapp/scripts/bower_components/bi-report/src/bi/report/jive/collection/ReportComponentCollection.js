 ...
 * @version: $Id: ReportComponentCollection.js 2849 2014-11-13 08:16:59Z ykovalchyk $
 */
        ...
        initialize: function(models, options){
            ...
            this.on("change add reset remove", function() {
                ...
                self.forEach(function(componentModel) {
                    self[componentModel.get("type")] && self[componentModel.get("type")].push(componentModel);
                });
            });
        },
