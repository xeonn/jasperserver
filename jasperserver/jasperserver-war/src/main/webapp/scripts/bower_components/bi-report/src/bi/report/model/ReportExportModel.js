 ...
 * @version: $Id: ReportExportModel.js 2698 2014-10-02 11:26:26Z inesterenko $
 */
    ...
    var ReportExportModel = BaseModel.extend({
        ...
        run: function(settings) {
            ...
            var data = _.extend(
                ...
                this.report.execution.pick("outputFormat", "pages", "attachmentsPrefix","allowInlineScripts", "markupType", "baseUrl"),
                this.get("options") ? _.pick(this.get("options"), "outputFormat", "pages", "attachmentsPrefix","allowInlineScripts", "markupType", "baseUrl") : {},
                settings);
        ...
        fetchOutput: function() {
            ...
            return Backbone.ajax({
                ...
                if (self.get("options").outputFormat === reportOutputFormats.HTML) {
                    output = response.markup ? response.markup : response;
                }
