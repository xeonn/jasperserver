...
/**
 * @version $Id: jasperreports-loader.js 45722 2014-05-14 10:24:22Z sergey.prilukin $
 */
                    ...
                    if(jqXHR.status >= 400) {
                        ...
                        if(jqXHR.responseText.indexOf('id="errorPageContent"') >= 0) {
                            ...
                            if(jqXHR.responseText.indexOf('{"result":{"msg":"') >= 0) {
                                var jsonErrorMessage = jQuery.parseJSON(jqXHR.responseText);
            ...
            if(!jqXHR.getResponseHeader('SuppressError')) {
                if($('.dashboardViewFrame').length == 1) {
                    ...
                    if (responseTextHasChartTypeChangeErrors(jqXHR.responseText)) {
                        setTimeout(function() {
                            var $alertBox = jQuery("#standardAlert"),
                                $dimmer = jQuery(".dimmer"),
                            ...
                            $btn.on("click", function() {
                                ...
                                buttonManager.disable(jQuery('#redo')[0]);
                                ...
                                if (viewer.reportInstance.components && viewer.reportInstance.components.chart && viewer.reportInstance.components.chart[0]) {
                                    jQuery("[data-hcname]").removeClass("selected");
                                    jQuery("[data-hcname='" + viewer.reportInstance.components.chart[0].config.charttype + "']").addClass("selected");
                                }
