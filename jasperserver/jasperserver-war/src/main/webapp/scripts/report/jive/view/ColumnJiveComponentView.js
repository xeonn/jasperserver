 ...
 * @version: $Id: ColumnJiveComponentView.js 45580 2014-05-10 14:31:59Z inesterenko $
 */
...
define(function (require) {
    ...
    return BaseJiveComponentView.extend({
        _renderComponent: function(){
            var jiveColumn = this.model.get("moduleType"),
                dfd = new $.Deferred();

            jiveColumn.init(this.report);

            log.debug("Apply column jive component: ", jiveColumn);
