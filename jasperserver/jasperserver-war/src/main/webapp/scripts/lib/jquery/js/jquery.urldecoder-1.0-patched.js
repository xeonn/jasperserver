...
//Jaspersoft Updates
////////////////////////////////////////////////////////////////////////////////////////////////
// #1 05/16/201:2 Do not convert values to the type, leave it as string:
// Because: It doesn't properly handle 'undefined' value, moreover, we basically don't need typed values.
//
// #2 05/16/2012: Do not replace false (false, null, undefined, empty string, 0, NaN) values with window.location.toString().
// Because: We need to obtain empty string value.
//
// #3 01/21/2014: Clarification of MIT Licensed Code: 
// See "OTHER PARTIES' CODE" section above.
// Steven Levithan makes his parseUri code available under the MIT license as can be seen by the sentence on
// his website which says: "Released under the MIT License".
// The link is here: http://blog.stevenlevithan.com/archives/parseuri
/////////////////////////////////////////////////////////////////////////////////////////////////
...
jQuery.url = function($){
	...
	function parse(url_str) {
		...
		*/
		if(uri.query){
			uri.params = deparam(uri.query, /* JASPERSOFT #1 */ false /* END JASPERSOFT #1 */);
		}
