 ...
 * @version: $Id: touch.controller.js 45722 2014-05-14 10:24:22Z sergey.prilukin $
 */
...
TouchController = function(element,parent,options) {
    ...
    if(options.scrollbars === true) {
        var hbar = jQuery('<div style="position:absolute;bottom:4px;left:0;right:0;"><div style="position:relative;background:#3fb8fa;min-height:4px;width:24px;opacity:0.4;"></div></div>').appendTo(parent);
        var vbar = jQuery('<div style="position:absolute;top:0;bottom:0;right:4px;"><div style="position:relative;background:#3fb8fa;min-width:4px;height:24px;opacity:0.4;"></div></div>').appendTo(parent);
