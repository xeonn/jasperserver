...
<%@ page import="net.sf.jasperreports.engine.util.JRStringUtil" %>
<%@ page import="net.sf.jasperreports.engine.util.JRStringUtil" %>
		...
		<t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
		    ...
		    <t:putAttribute name="bodyContent">
				...
				<div id="stepDisplay">
                    ...
                    <%  if(ex instanceof SessionAttribMissingException) { %>
                        <input type="hidden" name="sessionAttributeMissingException" value="true"/>
                    <%  }  %>
                            ...
                            <fieldset class="row inputs oneColumn">
                                <t:insertTemplate template="/WEB-INF/jsp/templates/container.jsp">
                                    ...
                                    <t:putAttribute name="bodyContent">
	                                    ...
	                                    %>
	                                                <p class="large"><%=JRStringUtil.htmlEncode(token)%></p>
	                                    <%
	    	                                	}
	                                    %>
	                                            </div>
