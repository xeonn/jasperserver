 ...
 * @version: $Id: BaseModelTests.js 41290 2014-02-03 13:57:46Z inesterenko $
 */
    ...
    describe("BaseModel", function() {
        ...
        describe("Create Server Error", function() {
            ...
            it("can serialize error from server response", function(){
                var fakeXhr = {
                    responseText : '{"message":"Something 1 wrong 2","errorCode":"something.wrong","parameters":[1,2]}'
                };
        ...
        it("should serialize server response and issue new 'error:*' events when 'error' event is triggered on model", function() {
            var model = new BaseModel(),
                ...
                errorObj = { message: "Not Found!!!", errorCode: "e123", parameters: [1] };
