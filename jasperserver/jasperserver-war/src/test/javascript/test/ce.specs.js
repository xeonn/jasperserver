...
/**
 * @author: inesterenko
 * @version: $Id: ce.specs.js 45722 2014-05-14 10:24:22Z sergey.prilukin $
 */
...
//    "tests/import.tests",
    ...
    "tests/scalable.list.tests",
    "tests/list.with.selection.tests",
    "tests/single.select.tests",
    "tests/available.items.list.tests",
    "tests/selected.items.list.tests",
