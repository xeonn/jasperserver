...
define(function(require) {
    "use strict";
    var settingsUtility = require("dataSource/util/settingsUtility");
    describe("Tests for settingsUtility ", function(){
        it("Check if deepDefaults is working correctly", function() {
            var deepDefaults = settingsUtility.deepDefaults({
                settingsGroup1: {group1Setting1:"group1Setting1OptionValue", group1Setting2:"group1Setting2OptionValue"},
                settingsGroup3: {group3Setting1:"group3Setting1OptionValue"}
            }, {
                settingsGroup1: {group1Setting1:"group1Setting1DefaultValue", group1Setting2:"group1Setting2DefaultValue"},
                settingsGroup2: {group2Setting1:"group2Setting1DefaultValue"},
                settingsGroup3: {group3Setting1:"group3Setting1DefaultValue", group3Setting2:"group3Setting2DefaultValue"}
            });
