 ...
 * @version: $Id: AwsDataSourceViewTests.js 42553 2014-03-04 11:37:20Z ykovalchyk $
 */
...
define(function(require) {
	...
	describe("Testing AwsDataSourceView", function() {
		...
		var awsDataSourceView, fakeServer, root;
		...
		describe("AwsDataSourceView's work", function() {
			...
			it("Check if everything has proper default value", function() {
				...
				// check page title
				expect(document.title).toBe(i18n["jsp.home.content_title"] + ": " + i18n["resource.datasource.aws.page.title.new"]);
				...
				expect(root.find("[name=connectionUrl]").val()).toBe("");
