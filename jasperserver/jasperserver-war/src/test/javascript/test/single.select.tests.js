...
/**
 * @version: $Id: single.select.tests.js 43122 2014-03-18 12:44:22Z psavushchik $
 */
...
define([
    ...
    "underscore",
    "core.layout",
    "common/component/singleSelect/SingleSelect",
    "text!templates/single.select.htm",
    "text!templates/single.select.list.htm",
    "text!templates/single.select.list.items.htm"
    ],

    function ($, _, layoutModule, SingleSelect, singleSelectTemplate, singleSelectListTemplate, singleSelectListItemsTemplate) {
        ...
        describe("SingleSelect", function () {
            ...
            it("should add expanded class to the component, scroll to selectied element, focus on input on click on collapsed component", function(){
                var hasFocus = false;
                ...
                expect(sList.scrollTop() > 127500).toBeTruthy();
            ...
            it("should filter out values on keydown in search input", function(){
                ...
                expect(sList.find("li").length).toEqual(9);
            });
