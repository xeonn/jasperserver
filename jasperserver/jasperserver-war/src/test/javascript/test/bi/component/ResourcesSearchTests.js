    ...
    describe('ResourcesSearch BI component', function(){
        ...
        describe('instance creation', function(){
            ...
            it("should create simple properties", function(){
                ...
                propertyNames = ['server', 'q', 'folderUri', 'types', 'offset', 'limit', 'recursive', 'sortBy', 'accessType', 'showHiddenItems', 'forceTotalCount'],
            ...
            it("should set simple values via properties method", function() {
                var inst = new ResourcesSearch(),
                    ...
                    propertyNames = ['server', 'q', 'folderUri', 'types', 'offset', 'limit', 'recursive', 'sortBy', 'accessType', 'showHiddenItems', 'forceTotalCount'], value = "sapi", value2 = "urg";
        ...
        describe("action Run", function(){
            var defaultSettings = {server: "http://localhost:8080/jasperserver-pro"},
                defaultData = {resourceLookup: []},
                server;
            ...
            it("should take callback and run it on resolve", function(){
                var sucsess = sinon.spy(),
                    failure = sinon.spy(),
                    inst = new ResourcesSearch(defaultSettings),
            ...
            it("should construct url properly - defaults", function(){
                var sucsess = sinon.spy(),
                    failure = sinon.spy(),
                    url = defaultSettings.server + "/rest_v2/resources?",
                    inst = new ResourcesSearch(defaultSettings);

                server.respondWith(url, [200, {}, JSON.stringify(defaultData)]);
            ...
            it("should construct url properly - error", function(){
                var sucsess = sinon.spy(),
                    failure = sinon.spy(),
                    url = defaultSettings.server + "/rest_v2/resources?adfsdffsfdf",
                    inst = new ResourcesSearch(defaultSettings);
            ...
            it("should construct url properly - server ends with slash", function(){
                var sucsess = sinon.spy(),
                    failure = sinon.spy(),
                    url = defaultSettings.server + "/rest_v2/resources?",
                    settings = {server: defaultSettings.server + "/" },
                    inst = new ResourcesSearch(settings);
            ...
            it("should construct url properly - parameter set", function(){
                var sucsess = sinon.spy(),
                    failure = sinon.spy(),
                    q = "adfaugawpuib",
                    url = defaultSettings.server + "/rest_v2/resources?q=" + q,
                    inst = new ResourcesSearch(defaultSettings);
            ...
            it("should construct url properly - multiple parameters set", function(){
                var sucsess = sinon.spy(),
                    ...
                    folderUri = "/saii/fa",
                    recursive = false,
                    url = defaultSettings.server + "/rest_v2/resources?q=" + q +"&folderUri=" + folderUri + "&recursive=" + recursive,
                    inst = new ResourcesSearch(defaultSettings);
        ...
        describe("action Validate", function(){
            ...
            it ("should validate on run and pass validation error to errback", function(){
                var inst = new ResourcesSearch({server: "http://localhost:8080/jasperserver-pro", recursive:"yes"}),
                    spy = sinon.spy();
