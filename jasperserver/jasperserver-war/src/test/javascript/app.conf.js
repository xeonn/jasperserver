...
/**
 * @author: inesterenko
 * @version: $Id: app.conf.js 45722 2014-05-14 10:24:22Z sergey.prilukin $
 */

// This file uses in Javascript Testing
...
define(function () {
		...
		// hack to add mocking for some libs and utils
        var requireJsPaths = window.paths;
        requireJsPaths["bundle"] = jrsConfigs.testPath + "/../mock/bundlePluginMock";
        requireJsPaths.settings = jrsConfigs.testPath + "/../mock/settingsPluginMock";
        requireJsPaths["common/util/featureDetection"] = jrsConfigs.testPath + "/../mock/featureDetectionMock";
        requireJsPaths["common/transport/request"] = jrsConfigs.testPath + "/../mock/requestMock";
        requireJsPaths["jive"] = jrsConfigs.testPath + "/../mock/jiveMock";

        // now, return the configuration
        return {

            jasperserver: jrsConfigs, //put jasperserver properties here

            requirejs:{

                baseUrl: jrsConfigs.srcPath, // point to source files
