 ...
 * @version $Id: ReportJobSimpleTriggerClientExtension.java 38348 2013-09-30 04:57:18Z carbiv $
 */
@XmlRootElement(name = "simpleTrigger")
public class ReportJobSimpleTriggerClientExtension extends ReportJobSimpleTrigger {
    public ReportJobSimpleTriggerClientExtension(){}
    public ReportJobSimpleTriggerClientExtension(ReportJobSimpleTrigger source){
        super(source);
    }
